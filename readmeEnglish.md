...
Video modes can be selected during boot (500 ms) or reboot, and another time can be specified in <b>gbConfig.h</b>b> in the <b>use_lib_boot_time_select_vga</b>b> section , by simply pressing the same key, from '0' to 'F'.<br>
